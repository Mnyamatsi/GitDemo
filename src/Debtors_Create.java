...
public class Debtors_Create {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement Element1 = driver.findElement(By.xpath("//div[text()='Debtors']"));
        // Scrolling down the page till the element is found		
        js.executeScript("arguments[0].scrollIntoView();", Element1);
        Thread.sleep(2000);
		driver.findElement(By.xpath("//div[text()='Debtors']")).click();
		driver.findElement(By.xpath("//div[text()='Debtors Details']")).click();
