...
public class Login_Failed {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.id("txt_login_password")).sendKeys("@Baster321");
		...
		Thread.sleep(1000);
		Assert.assertEquals(driver.findElement(By.xpath("//body[1]/div[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/form[1]/p[1]")).getText(),"Incorrect username or password.");
		Thread.sleep(1000);
		System.out.println(driver.findElement(By.xpath("//body[1]/div[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/form[1]/p[1]")).getText());
		driver.close();
	}
